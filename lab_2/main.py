...
class Lab2:
    ...
    def student(self, n=11, g=81):
        ...
        Label(self.slave, text='Дьяченко Тетяна\n'
                               'група ІВ-{}\n'
                               'варіант {}'.format(g, (n+g % 60) % 30+1),
    ...
    def mainwindow(self):
        ...
        Button(self.root, text='Вікно 2', font="Arial 12", command=self.window2).grid(row=1, column=0)
        Button(self.root, text='Вікно 3', font="Arial 12", command=self.window3).grid(row=2, column=0)
        Button(self.root, text='Вікно 4', font="Arial 12", command=self.window4).grid(row=3, column=0)
    ...
    def window3(self):
        ...
        dict_SA = {}
        dict_SB = {}
        canvS.create_text(160, 30, text='Множина aSb, якщо a кум b', font='Arial 16')
        ...
        dict_RA = {}
        dict_RB = {}
        canvR.create_text(160, 30, text='Множина aRb, якщо a чоловік b', font='Arial 16')
        for i in range(len(self.A)):
